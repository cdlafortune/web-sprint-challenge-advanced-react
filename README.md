...
1. Explain how to build stateful class components.
    ...
    Declare the component as a class that extends the parent React.Component, then set up the component's state through a constructor function. The return for the component needs to be wrapped in a render() method. 
...
4. Define stateful logic.
    ...
    In class components, state is initiated in the constructor and updated through setState(). Without classes, state is managed through the useState() hook. 
